...
<head>
  ...
  <title>الإضاءة والبطاريات</title>
...
<body>
  ...
  <!-- ✅ عنوان الصفحة -->
  <div class="container">
    <h2 class="text-center my-4">جميع قطع الإضاءة والبطاريات</h2>

    <!-- ✅ البطاقات -->
    <div class="row">
      @forelse($lightBatteries as $item)
        <div class="col-md-4 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="{{ route('lights-batteries.show', $item->id) }}" class="btn btn-warning btn-sm">تفاصيل</a>
            </div>
          </div>
        </div>
      @empty
