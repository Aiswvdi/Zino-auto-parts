...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold">Zino Part</span>
    </a>
  </div>
...
<li class="nav-item">
  <a class="nav-link {{ (Request::is('order_items') ? 'active' : '') }}" href="{{ url('order_items') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">تفاصيل الطلبات</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link {{ (Request::is('warehouses') ? 'active' : '') }}" href="{{ url('warehouses') }}">
    ...
    <span class="nav-link-text ms-1">المخازن</span>
  </a>
</li>

<li class="nav-item">
  <a class="nav-link {{ (Request::is('stock_issue_orders') ? 'active' : '') }}" href="{{ url('stock_issue_orders') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">امر الصرف المخزني</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link {{ (Request::is('payments') ? 'active' : '') }}" href="{{ url('payments') }}">
    ...
    <span class="nav-link-text ms-1">الدفعات</span>
  </a>
</li>

<li class="nav-item">
  <a class="nav-link {{ (Request::is('returns') ? 'active' : '') }}" href="{{ url('returns') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">المرتجعات</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('shippings') ? 'active' : '') }}" href="{{ url('shippings') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">الشحنات</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('suppliers') ? 'active' : '') }}" href="{{ url('suppliers') }}">
    ...
    <span class="nav-link-text ms-1">الموردين</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('supplier_payments') ? 'active' : '') }}" href="{{ url('supplier_payments') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">حسابات الموردين</span>
  </a>
</li>

<li class="nav-item">
  <a class="nav-link {{ (Request::is('shipment_tracking') ? 'active' : '') }}" href="{{ url('shipment_tracking') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">تتبع الشحنات</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('product_images') ? 'active' : '') }}" href="{{ url('product_images') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">الصفحة الرئيسية للعملاء</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('engine_parts') ? 'active' : '') }}" href="{{ url('engine_parts') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">قسم المحركات</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('brake-parts') ? 'active' : '') }}" href="{{ url('brake-parts') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">قسم الفرامل</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('suspension-parts') ? 'active' : '') }}" href="{{ url('suspension-parts') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">قسم المساعدات</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('fluid-oils') ? 'active' : '') }}" href="{{ url('fluid-oils') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">قسم الزيوت</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link {{ (Request::is('lights-batteries') ? 'active' : '') }}" href="{{ url('lights-batteries') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>box-3d-50</title>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span class="nav-link-text ms-1">قسم الاضاءة</span>
  </a>
</li>
      <li class="nav-item">
