...
<div class="container mt-5">
    <h2 class="header-title">قطع الفرامل</h2>

    <div class="row">
        @foreach($brakeParts as $part)
            <div class="col-md-4">
                <a href="{{ url('/brake-parts/'.$part->id) }}" class="part-card">
                    <img src="{{ asset('storage/' . $part->image) }}" alt="نظام الفرامل">
                    <h4>{{ $part->name }}</h4>
